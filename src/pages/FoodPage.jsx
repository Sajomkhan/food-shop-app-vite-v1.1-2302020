...
const FoodPage = () => {
  ...
  const filterFoodByLocation = data.filter(
    (item) => item.price === location.state
  );
  ...
  return (
    <div className="px-4 mb-11 mt-6 md:mt-20 w-11/12 mx-auto">
      ...
      <h1 className="text-purple-700 font-bold text-2xl md:text-4xl md:text-center my-4">
        Top Rated Food's Items
      </h1>
        ...
        {foods.map((item, index) => (
          ...
          >
            ...
            <div className="flex flex-col w-full items-center">
              <p className="font-semibold text-[17px] place-self-start ml-3">
                {item.name}
              </p>
